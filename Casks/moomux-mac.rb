cask "moomux-mac" do
  version "0.0.75"
  sha256 "ed538e634515fcafcba6705d67566326995b36343ce283ba44ba2e5b5353bf5a"

  url "https://github.com/afitzgerald/moomux-mac/releases/download/v0.0.75/Moomux-v0.0.75.dmg"
  name "Moomux"
