cask "moomux-mac" do
  version "0.0.42"
  sha256 "ed5e1e379a040c56a03bc643b3b59df28bd4f58393a6a5c0d5cc41c224c8f01f"

  url "https://github.com/afitzgerald/moomux-mac/releases/download/v0.0.42/Moomux-v0.0.42.dmg"
  name "Moomux"
