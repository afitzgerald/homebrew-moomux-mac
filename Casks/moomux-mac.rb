cask "moomux-mac" do
  version "0.0.50"
  sha256 "473859718944341294831ccb1aaaab5ceeab73bae9e9e9aaa1a741ab9a96649a"

  url "https://github.com/afitzgerald/moomux-mac/releases/download/v0.0.50/Moomux-v0.0.50.dmg"
  name "Moomux"
