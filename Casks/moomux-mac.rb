cask "moomux-mac" do
  version "0.0.44"
  sha256 "fc88ede0b7961b1dc9fb7b83c37955b4d7fd7d92f9ba285cd163a60c0d1e3e59"

  url "https://github.com/afitzgerald/moomux-mac/releases/download/v0.0.44/Moomux-v0.0.44.dmg"
  name "Moomux"
